...
const Invitation = ({guestName}) => {
  ...
  return (
    ...
    <div className='w-full my-1 mt-8  flex justify-center pt_sarief text-2xl'>Dear {guestName}, </div>
    ...
    <div className='w-full text-center p-5   flex justify-center pt_sarief text-2xl'>46/6, Haque Tower, M-block, Main Road, Banasree, Dhaka-1219 Dhaka </div>
